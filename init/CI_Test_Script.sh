...
tg_sendinfo "<code>I am gonna merge staging into  Zeinzo-Userbot</code>"
cd
...
git push --force origin staging:  Zeinzo-Userbot
tg_sendinfo "<code>I have merged all commits from staging into  Zeinzo-Userbot</code>"
